---
template_id: YS-INFRA-DELL-IDRAC-001
template_family: hwsys
title: Dell iDRAC Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for Dell iDRAC inventory, power, lifecycle, BIOS, firmware, and Redfish controls.
...
racadm getsysinfo
racadm getversion
curl -fsS -k https://<idrac>/redfish/v1/
ipmitool -I lanplus -H <idrac> mc info
```
