---
template_id: YS-HW-TURINGPI-MITX-JETSON-XAVIER-NX-001
template_family: hwsys
title: Turing Pi mITX Board with Jetson Xavier NX Agent Standard
version: 0.1.0
status: draft
owner_role: platform-engineering
applies_to:
  - Turing Pi mITX Board with Jetson Xavier NX
  - Turing Pi mITX
  - cluster board
  - BMC
audience:
...
# Turing Pi mITX Board with Jetson Xavier NX Agent Standard
...
Define controls for Turing Pi mITX Board with Jetson Xavier NX slot, BMC, node power, storage, networking, and serial workflows.
