---
template_id: YS-NET-VPN-PROTOCOLS-001
template_family: hwsys
title: Advanced VPN Protocols Agent Standard
version: 0.1.0
status: draft
...
# Advanced VPN Protocols Agent Standard
...
Define agent controls for VPN protocol selection, routing, identity, key, and rollback controls.
...
wg show
openvpn --version
swanctl --version || ipsec --version
nebula -version || true
zerotier-cli info || true
sshuttle --version || true
```
