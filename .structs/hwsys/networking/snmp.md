---
template_id: YS-NET-SNMP-001
template_family: hwsys
title: SNMP v1/v2c/v3 Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for SNMP monitoring, authentication, privacy, community, and MIB controls.
...
```text
snmpget -v3 -l authPriv ... <oid>
snmpwalk -v3 -l authPriv ... <oid>
snmptranslate -Tp
grep -R "rocommunity\|rwcommunity" /etc/snmp
```
