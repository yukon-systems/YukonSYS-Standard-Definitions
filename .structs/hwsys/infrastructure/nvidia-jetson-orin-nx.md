---
template_id: YS-INFRA-NVIDIA-JETSON-ORIN-NX-001
template_family: hwsys
title: NVIDIA Jetson Orin NX Agent Standard
version: 0.1.0
status: draft
...
# NVIDIA Jetson Orin NX Agent Standard
...
Define agent controls for Jetson Orin NX JetPack/L4T, flashing, power, thermal, device-tree, and performance controls.
