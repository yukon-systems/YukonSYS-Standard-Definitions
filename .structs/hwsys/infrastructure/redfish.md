---
template_id: YS-INFRA-REDFISH-001
template_family: hwsys
title: Redfish Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for Redfish REST resource, session, task, firmware, event, and inventory controls.
...
```text
curl -fsS -k https://<bmc>/redfish/v1/
curl -fsS -k https://<bmc>/redfish/v1/Systems
curl -fsS -k https://<bmc>/redfish/v1/Managers
```
