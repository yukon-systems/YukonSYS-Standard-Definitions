---
template_id: YS-NET-HPC-TCP-UDP-TUNING-001
template_family: hwsys
title: Advanced TCP/UDP Options for HPC Tuning Standard
version: 0.1.0
status: draft
...
# Advanced TCP/UDP Options for HPC Tuning Standard
...
Define agent controls for Linux/BSD network buffer, MTU, congestion, offload, IRQ, queue, and measurement controls.
