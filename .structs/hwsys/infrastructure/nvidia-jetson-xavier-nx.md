---
template_id: YS-INFRA-NVIDIA-JETSON-XAVIER-NX-001
template_family: hwsys
title: NVIDIA Jetson Xavier NX Agent Standard
version: 0.1.0
status: draft
...
# NVIDIA Jetson Xavier NX Agent Standard
...
Define agent controls for Jetson Xavier NX JetPack/L4T, flashing, power, thermal, device-tree, and performance controls.
