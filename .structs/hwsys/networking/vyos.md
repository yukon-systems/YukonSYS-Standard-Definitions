---
template_id: YS-NET-VYOS-001
template_family: hwsys
title: VyOS Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for VyOS configure/commit-confirm/save workflow and network service validation.
