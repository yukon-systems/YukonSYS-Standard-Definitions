---
template_id: YS-INFRA-U-BOOT-001
template_family: hwsys
title: U-Boot Loader Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for U-Boot environment, bootcmd, extlinux, FIT, serial recovery, and saveenv controls.
...
help
setenv <name> <value>
saveenv # only after approval and backup
```
