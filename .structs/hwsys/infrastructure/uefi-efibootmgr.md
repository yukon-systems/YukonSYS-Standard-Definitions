---
template_id: YS-INFRA-UEFI-EFIBOOTMGR-001
template_family: hwsys
title: UEFI and efibootmgr Agent Standard
version: 0.1.0
status: draft
...
# UEFI and efibootmgr Agent Standard
...
Define agent controls for UEFI boot entries, boot order, Secure Boot, NVRAM, and recovery controls.
