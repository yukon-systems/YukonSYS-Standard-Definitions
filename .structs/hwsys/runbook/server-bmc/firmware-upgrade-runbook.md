---
template_id: CRMR-TPL-HW-FIRMWARE-UPGRADE-RUNBOOK
template_family: hardware-runbook
title: Firmware Upgrade Runbook
version: 1.0.0
status: active
owner_role: Hardware Owner
applies_to:
  - repository
  - service
  - release
...
- [Backout / Recovery](#backout--recovery)
