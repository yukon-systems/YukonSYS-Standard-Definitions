---
template_id: YS-INFRA-SERIAL-FREEBSD-001
template_family: hwsys
title: RS232 / RS485 / TTL Serial via FreeBSD Agent Standard
version: 0.1.0
status: draft
...
# RS232 / RS485 / TTL Serial via FreeBSD Agent Standard
...
Define agent controls for FreeBSD serial console, USB UART, device naming, permissions, and logging controls.
...
```text
dmesg | grep -i uart
ls -l /dev/cuau* /dev/ttyu* /dev/cuaU* 2>/dev/null
stty -f /dev/<tty> -a
cu -l /dev/<tty> -s <baud>
```
