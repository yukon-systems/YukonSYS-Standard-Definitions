---
template_id: YS-NET-ROCE-001
template_family: hwsys
title: RoCE v1 and RoCE v2 Agent Standard
version: 0.1.0
status: draft
...
# RoCE v1 and RoCE v2 Agent Standard
...
Define agent controls for RoCE lossless Ethernet, PFC/ECN/DCB, MTU, VLAN priority, and congestion-control validation.
...
ethtool -i <iface>
ethtool -S <iface>
lldptool -t -n -i <iface> || true
dcbtool gc <iface> || true
```
