---
template_id: YS-INFRA-SUPERMICRO-SUM-DCM-001
template_family: hwsys
title: Supermicro SUM / Datacenter Manager Tools Agent Standard
version: 0.1.0
status: draft
...
# Supermicro SUM / Datacenter Manager Tools Agent Standard
...
Define agent controls for Supermicro BIOS/BMC inventory, config, and firmware tooling controls.
...
```text
sum -i <bmc> -u <user> -p <redacted> -c GetBiosInfo
sum -i <bmc> -u <user> -p <redacted> -c GetBmcInfo
```
