---
template_id: YS-INFRA-HPE-ILO-001
template_family: hwsys
title: HPE iLO Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for HPE iLO inventory, firmware, BIOS, power, and Redfish controls.
...
```text
ilorest serverinfo || true
ilorest get --select Bios. || true
curl -fsS -k https://<ilo>/redfish/v1/
```
