---
template_id: YS-INFRA-OPENBMC-001
template_family: hwsys
title: OpenBMC Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for OpenBMC inventory, Redfish/IPMI, service, firmware, and recovery workflows.
...
ipmitool -I lanplus -H <bmc> mc info
ssh <bmc> journalctl -n 100 || true
```
