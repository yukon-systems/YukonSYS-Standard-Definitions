---
template_id: YS-HW-TURINGPI-MITX-CM4-001
template_family: hwsys
title: Turing Pi mITX Board with Raspberry Pi CM4 Agent Standard
version: 0.1.0
status: draft
owner_role: platform-engineering
applies_to:
  - Turing Pi mITX Board with Raspberry Pi CM4
  - Turing Pi mITX
  - cluster board
  - BMC
audience:
...
# Turing Pi mITX Board with Raspberry Pi CM4 Agent Standard
...
Define controls for Turing Pi mITX Board with Raspberry Pi CM4 slot, BMC, node power, storage, networking, and serial workflows.
