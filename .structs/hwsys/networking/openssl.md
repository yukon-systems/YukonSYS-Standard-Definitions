---
template_id: YS-NET-OPENSSL-001
template_family: hwsys
title: OpenSSL 1.x and 3.x Agent Standard
version: 0.1.0
status: draft
...
# OpenSSL 1.x and 3.x Agent Standard
...
Define agent controls for OpenSSL command, library, provider, FIPS, certificate, and TLS validation controls.
