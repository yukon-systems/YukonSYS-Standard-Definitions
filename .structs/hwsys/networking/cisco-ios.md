---
template_id: YS-NET-CISCO-IOS-001
template_family: hwsys
title: Cisco IOS Agent Standard
version: 0.1.0
status: draft
owner_role: platform-engineering
applies_to:
  - Cisco IOS
  - IOS XE where applicable
audience:
  - agentic-workers
  - platform-engineers
  - reviewers
...
Define agent controls for Cisco IOS configuration, archive, reload safety, interface/routing validation.
