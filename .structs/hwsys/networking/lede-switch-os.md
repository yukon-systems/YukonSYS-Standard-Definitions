---
template_id: YS-NET-LEDE-SWITCH-OS-001
template_family: hwsys
title: LEDE Switch OS Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for Legacy LEDE/OpenWrt-derived switch/router handling.
...
```text
cat /etc/openwrt_release || cat /etc/os-release
uci show
opkg list-installed
logread
