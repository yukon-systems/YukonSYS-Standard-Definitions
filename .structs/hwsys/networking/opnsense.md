---
template_id: YS-NET-OPNSENSE-001
template_family: hwsys
title: OPNsense Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for OPNsense firewall/router management using config backups, UI/API, configctl, pf, and plugin controls.
...
ifconfig
sockstat -4 -6
cp /conf/config.xml /conf/config.xml.prechange
```
