---
template_id: YS-INFRA-SERIAL-SOLARIS-001
template_family: hwsys
title: RS232 / RS485 / TTL Serial via Solaris Agent Standard
version: 0.1.0
status: draft
...
# RS232 / RS485 / TTL Serial via Solaris Agent Standard
...
Define agent controls for Solaris serial console, ttymon, eeprom console variables, and device controls.
...
pmadm -l || true
sacadm -l || true
ls -l /dev/term /dev/cua 2>/dev/null
stty -a < /dev/term/<n>
eeprom | grep console || true
```
