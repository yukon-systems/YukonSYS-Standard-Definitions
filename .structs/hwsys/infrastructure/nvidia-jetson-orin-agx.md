---
template_id: YS-INFRA-NVIDIA-JETSON-ORIN-AGX-001
template_family: hwsys
title: NVIDIA Jetson Orin AGX Agent Standard
version: 0.1.0
status: draft
...
# NVIDIA Jetson Orin AGX Agent Standard
...
Define agent controls for Jetson AGX Orin JetPack/L4T, flashing, power, thermal, device-tree, and performance controls.
