---
template_id: YS-HW-TURINGPI-MITX-BOARD-BMC-001
template_family: hwsys
title: Turing Pi mITX Board + BMC Agent Standard
version: 0.1.0
status: draft
owner_role: platform-engineering
applies_to:
  - Turing Pi mITX Board + BMC
  - Turing Pi mITX
  - cluster board
  - BMC
audience:
...
# Turing Pi mITX Board + BMC Agent Standard
...
Define controls for Turing Pi mITX Board + BMC slot, BMC, node power, storage, networking, and serial workflows.
