---
template_id: YS-INFRA-INTEL-AMT-001
template_family: hwsys
title: Intel AMT Remote Management Agent Standard
version: 0.1.0
status: draft
...
# Intel AMT Remote Management Agent Standard
...
Define agent controls for AMT provisioning, TLS, remote KVM/power, and audit controls.
...
```text
meshcmd amtinfo --host <host> || true
amttool <host> info || true
ping <amt-host>
```
