---
template_id: YS-NET-OFED-INFINIBAND-001
template_family: hwsys
title: OFED InfiniBand Protocol Agent Standard
version: 0.1.0
status: draft
...
# OFED InfiniBand Protocol Agent Standard
...
Define agent controls for InfiniBand/RDMA fabric inventory, health, subnet manager, and performance controls.
...
perfquery
sminfo
systemctl status opensm || service opensm status
```
