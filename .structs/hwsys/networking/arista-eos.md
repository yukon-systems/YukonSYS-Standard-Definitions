---
template_id: YS-NET-ARISTA-EOS-001
template_family: hwsys
title: Arista EOS Agent Standard
version: 0.1.0
status: draft
...
Define agent controls for EOS switch operations, configuration sessions, rollback, MLAG/routing/interface validation.
