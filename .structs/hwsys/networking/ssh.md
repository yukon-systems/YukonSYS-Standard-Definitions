---
template_id: YS-NET-SSH-001
template_family: hwsys
title: OpenSSH and Dropbear SSH Agent Standard
version: 0.1.0
status: draft
...
# OpenSSH and Dropbear SSH Agent Standard
...
Define agent controls for SSH client/server configuration, host keys, auth methods, and embedded device SSH constraints.
