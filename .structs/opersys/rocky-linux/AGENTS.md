---
template_id: YS-OS-ROCKY-LINUX-9-10-001
template_family: opersys
title: Rocky Linux 9 + 10 Agent Standard
version: 0.1.0
status: draft
...
# Rocky Linux 9 + 10 Agent Standard
...
Define agent rules for Rocky Linux 9 + 10 systems.
...
- Use Rocky repositories and release notes.
- Do not assume Red Hat subscription tools exist.
