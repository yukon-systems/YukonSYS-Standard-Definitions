---
template_id: YS-OS-ORACLE-LINUX-9-10-001
template_family: opersys
title: Oracle Enterprise Linux 9 + 10 Agent Standard
version: 0.1.0
status: draft
...
# Oracle Enterprise Linux 9 + 10 Agent Standard
...
Define agent rules for Oracle Enterprise Linux 9 + 10 systems.
...
- Distinguish RHCK and UEK kernels.
- Use Oracle Linux repositories and UEK policy.
- Use `dnf`, `rpm`, `systemctl`, `nmcli`, and `firewall-cmd`.
