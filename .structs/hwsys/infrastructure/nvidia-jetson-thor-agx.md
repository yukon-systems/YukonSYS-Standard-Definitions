---
template_id: YS-INFRA-NVIDIA-JETSON-THOR-AGX-001
template_family: hwsys
title: NVIDIA Jetson Thor AGX Agent Standard
version: 0.1.0
status: draft
owner_role: platform-engineering
applies_to:
  - Jetson AGX Thor
  - Jetson Linux Release 39.x
audience:
  - agentic-workers
  - platform-engineers
  - reviewers
...
# NVIDIA Jetson Thor AGX Agent Standard
...
Define agent controls for Jetson AGX Thor JetPack/L4T, Blackwell edge-AI platform, flashing, power, thermal, and performance controls.
